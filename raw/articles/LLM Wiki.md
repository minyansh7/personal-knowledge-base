...
Dataview is an Obsidian plugin that runs queries over page frontmatter. If your LLM adds YAML frontmatter to pages (tags, dates, source counts), Dataview can generate dynamic tables and lists.

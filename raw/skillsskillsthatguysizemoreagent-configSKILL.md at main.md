---
title: "skills/skills/thatguysizemore/agent-config/SKILL.md at main"
source: "https://github.com/openclaw/skills/blob/main/skills/thatguysizemore/agent-config/SKILL.md?utm_source=chatgpt.com"
author:
published:
created: 2026-04-05
description: "All versions of all skills that are on clawhub.com archived - skills/skills/thatguysizemore/agent-config/SKILL.md at main · openclaw/skills"
tags:
  - "agent-config"
---
| name        | agent-config                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
```
1. Verify: grep -A 3 "Password Manager" - confirmed present
2. Document: Not needed (minor addition to existing rule)
